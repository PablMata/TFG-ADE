...
preds <- readRDS("data/preds_con_stoxx50.rds")

# Evaluación sobre retornos
rmse_val <- rmse(test_y, preds)
mae_val <- mae(test_y, preds)
r2_val <- R2(preds, test_y)

cat("Evaluación del modelo CON Stoxx50 (retornos):\n")
cat("RMSE:", rmse_val, "\n")
cat("MAE :", mae_val, "\n")
cat("R²  :", r2_val, "\n")
...
# Evaluación sobre precios calibrados
...
cat("\nEvaluación del modelo CON Stoxx50 (precios):\n")
