# Pipeline completo para predecir Oro con SP500 + Stoxx50

# 1. Crear carpetas necesarias si no existen
dirs <- c("data", "models", "results", "scriptsGold_ambos")
...
scripts <- list.files("scriptsGold_ambos", pattern = "\\.R$", full.names = TRUE)
scripts <- sort(scripts)

cat("\n--- INICIANDO PIPELINE PARA PREDICCIÓN DEL ORO (SP500 + STOXX50) ---\n")
